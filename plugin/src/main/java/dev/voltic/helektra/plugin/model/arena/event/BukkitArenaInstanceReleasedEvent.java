...
@Getter
public class BukkitArenaInstanceReleasedEvent extends BukkitArenaEvent {
    private final long usageDurationMs;
    private final long blocksModified;

    public BukkitArenaInstanceReleasedEvent(String arenaId, ArenaInstance instance, long usageDurationMs, long blocksModified) {
