...
@Singleton
public class EventStateHandler implements ProfileStateHandler {

  private final ProfileHotbarService hotbarService;

  @Inject
  public EventStateHandler(ProfileHotbarService hotbarService) {
    this.hotbarService = hotbarService;
  }

  @Override
  public ProfileState target() {
    return ProfileState.IN_EVENT;
  }

  @Override
  public void onEnter(Player player, IProfile profile) {
    hotbarService.apply(player, ProfileState.IN_EVENT);
  }
